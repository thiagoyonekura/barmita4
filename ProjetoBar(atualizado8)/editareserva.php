...
<div class="telareservacadastro">
    <h1>Fazer reserva de mesa</h1>
       ...
       ?>
        ...
        <br><br>
        <input type="radio" name="situacao" class="situacao" value="Ativo" required>Confirmar reserva
        <input type="radio" name="situacao" class="situacao" value="Inativo" required>Cancelar reserva
        <br><br>
